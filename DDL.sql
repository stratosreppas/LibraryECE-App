...
INSERT INTO transaction (visitor_id, book_id, borrow_date, must_return_date, return_date)
VALUES 
	(1, 9330, '2024-01-14', '2024-01-21', null),
  ( 3, 9321, '2022-01-01', '2022-01-07', '2022-01-06'),
  ( 3, 9322, '2022-01-02', '2022-01-09', '2022-01-07'),
  (3, 9323, '2022-01-03', '2022-01-10', '2022-01-08'),
  (3, 9345, '2022-01-03', '2022-01-10', '2022-01-08'),
  (3,9324,'2024-01-12','2024-01-19',NULL),
  (3,9327,'2024-01-14','2024-01-21',NULL),
  (3,9326,CURDATE(),CURDATE() + INTERVAL 7 DAY,NULL),
  (1, 9321, '2023-01-10', '2023-01-17', '2023-01-17'),
  (1, 9322, '2023-01-11', '2023-01-18', '2023-01-18'),
  (1, 9323, '2023-01-12', '2023-01-19', '2023-01-19'),
  (1, 9324, '2023-01-13', '2023-01-20', '2023-01-20'),
  (1, 9326, '2023-01-15', '2023-01-22', '2023-01-22'),
  (1, 9328, '2023-01-17', '2023-01-24', '2023-01-24'),
  (1, 9329, '2023-01-18', '2023-01-25', '2023-01-25'),
  (1, 9330, '2023-01-19', '2023-01-26', '2023-01-26'),
  (2, 9331, '2023-01-20', '2023-01-27', '2023-01-27'),
  (2, 9321, '2023-01-21', '2023-01-28', '2023-01-28'),
  (2, 9322, '2023-01-22', '2023-01-29', '2023-01-29'),
  (2, 9323, '2023-01-23', '2023-01-30', '2023-01-30'),
  (2, 9324, '2023-01-24', '2023-01-31', '2023-01-31'),
  (2, 9326, '2023-01-26', '2023-02-02', '2023-02-02'),
  (2, 9328, '2023-01-28', '2023-02-04', '2023-02-04'),
  (2, 9329, '2023-01-29', '2023-02-05', '2023-02-05'),
  (3, 9330, '2023-01-30', '2023-02-06', '2023-02-06'),
  (3, 9331, '2023-01-31', '2023-02-07', '2023-02-07'),
  (3, 9321, '2023-02-01', '2023-02-08', '2023-02-08'),
  (3, 9322, '2023-02-02', '2023-02-09', '2023-02-09'),
  (3, 9323, '2023-02-03', '2023-02-10', '2023-02-10'),
  (3, 9326, '2023-02-06', '2023-02-13', '2023-02-13'),
  (3, 9328, '2023-02-08', '2023-02-15', '2023-02-15'),
  (3, 9329, '2023-02-09', '2023-02-16', '2023-02-16'),
  (3, 9330, '2023-02-10', '2023-02-17', '2023-02-17'),
  (3, 9331, '2023-02-11', '2023-02-18', '2023-02-18'),
  (3, 9321, '2023-02-12', '2023-02-19', '2023-02-19'),
  (3, 9322, '2023-02-13', '2023-02-20', '2023-02-20'),
  (3, 9323, '2023-02-14', '2023-02-21', '2023-02-21');

INSERT INTO notifications (user_id,title,notification_date,content,category) 
VALUES
(3,"Χριστουγεννιάτικο Ωράριο Λειτουργίας Βιβλιοθήκης ΣΗΜΜΥ",CURRENT_DATE,"Η βιβλιοθήκη κατά τη διάρκεια των διακοπών των Χριστουγέννων θα είναι ανοιχτή 27-29/12/2023 και 3-5/1/2024 και ώρες 09.00-15.00.",0);

INSERT INTO notifications (user_id,title,notification_date,content,category) 
VALUES
(3,"Λειτουργία της βιβλιοθήκης ΗΜΜΥ 15-17\/11","2023-10-10","Η βιβλιοθήκη της ΣΗΜΜΥ τις ημέρες Τετάρτη 15/11 και Πέμπτη 16/11 θα υπολειτουργεί εως τις 15:00 και την Παρασκευή 17/11 θα παραμείνει κλειστή, μετά από απόφαση του φοιτητικού συλλόγου.",0);

INSERT INTO notifications (user_id,title,notification_date,content,category) 
VALUES
(3,"Επιστροφή Βιβλίου","2023-11-25","Παρακαλούμε να προχωρήσετε σε επιστροφή του βιβλίου άμεσα",1);

INSERT INTO notifications (user_id,title,notification_date,content,category) 
VALUES
(1,"Επιστροφή Βιβλίου","2023-12-30","Παρακαλούμε να προχωρήσετε σε επιστροφή του βιβλίου άμεσα",1);
